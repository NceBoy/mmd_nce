...
work_dir = './tools/work_dirs/vfnet_sandnet_4cls_3anchor_objectness_half_person_depther'
load_from = None
resume_from = './tools/work_dirs/vfnet_sandnet_4cls_3anchor_objectness_half_person_depther/epoch_18.pth'
# resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 2)
